    ...
    <th
      ...
      className={cn(
        ...
        props.tableLayout?.columnsPinnable && column.getCanPin() &&
          "[&[data-pinned][data-last-col]]:border-border data-pinned:bg-muted/90 data-pinned:backdrop-blur-xs [&[data-pinned=left][data-last-col=left]]:border-e! [&[data-pinned=right][data-last-col=right]]:border-s!",
...
function DataGridTableEmpty() {
  ...
  return (
    <tr>
      <td colSpan={totalColumns} className="text-muted-foreground text-xs py-6 text-center">
